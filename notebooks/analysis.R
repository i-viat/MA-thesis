...
data = read.csv("C://Users/User/Desktop/Participatory budgeting/scripts/dataset_for_analysis.csv") # specify path to the dataset
...
# Model 1
run_model('pb_count_sum', c("b_ins", "b_elt", "b_pro"), 
                  c('inst_qual_17', 'elites', 'pr_quan_avg'), data_84)

# Model 2
run_model('pb_count_sum', c("b_ins", "b_elt", "b_pro", "b_eff", "b_hdi", "b_tci"),  
                  c('inst_qual_17', 'elites', 'pr_quan_avg', 'total_eff', 'hdi_16', 'tci_avg'), data_84)

# Model 3
run_model('pb_count_sum', c("b_bal", "b_trf", "b_soc"),
                  c('budg_bal_avg',  'cbf_budg_tr_share_avg', 'soc_sp_pc_log'), data_84)

# Model 4
run_model('pb_count_sum', c("b_bal", "b_trf", "b_soc", "b_eff", "b_hdi", "b_tci"),  
                  c('budg_bal_avg', 'cbf_budg_tr_share_avg', 'soc_sp_pc_log', 'total_eff', 'hdi_16', 'tci_avg'))

# Model 5
run_model('pb_count_sum', c("b_ins", "b_elt", "b_pro", "b_bal", "b_trf", "b_soc"), 
...
# Model 7
run_model('pb_count_sum', full_model_coef,  full_model_cov, data_84, 
...
int.sim <- matrix(rep(NA, nrow(int.mcmc.dat)*length(x2.sim)), 
...
##########################################################
#####  Visualization of distributions  (Appendix 1)  #####
##########################################################

plot_hist = function(variable, name, var_name){
  data = data %>% filter(data[,variable] < 500) # only for project cost
  ggplot(data = data, aes(x=data[,variable])) + 
    geom_histogram(color="black", fill="white") + 
    xlab(paste(glue('Projects {var_name} by Region\n({name})'))) + 
    ylab('') +
    geom_vline(aes(xintercept=median(na.omit(data[,variable]))),
               color="red", linetype="dashed", size=1)
}  

p1 = plot_hist('pb_count_19', '2019', 'Count')
p2 = plot_hist('pb_count_20', '2020', 'Count')
p3 = plot_hist('pb_count_21', '2021', 'Count')
p4 = plot_hist('pb_count_mean', 'average 2019–2021', 'Count')
p5 = plot_hist('pb_count_sum', 'total 2019–2021', 'Count')

##### Figure 1.1 #####
ggarrange(p1, p2, p3, p4, p5, ncol = 3, nrow = 2)

data$project_cost_19 = data$project_cost_19/1000000
data$project_cost_20 = data$project_cost_20/1000000
data$project_cost_21 = data$project_cost_21/1000000
data$project_cost_mean = data$project_cost_mean/1000000
data$project_cost_tot = data$project_cost_tot/1000000

p6 = plot_hist('project_cost_19', '2019', 'Cost')
p7 = plot_hist('project_cost_20', '2020', 'Cost')
p8 = plot_hist('project_cost_21', '2021', 'Cost')
p9 = plot_hist('project_cost_mean', 'average 2019–2021', 'Cost')
p10 = plot_hist('project_cost_tot', 'total 2019–2021', 'Cost')

##### Figure 1.2 #####
ggarrange(p6, p7, p8, p9, p10, ncol = 3, nrow = 2)
...
##### Table 3.1: #####
# Model 1
run_model('pb_count_19', c("b_ins", "b_elt", "b_pro", "b_bal", "b_trf", "b_soc"), 
                     c('inst_qual_17', 'elites', 'pr_quan_avg', "budg_bal_19", "cbf_budg_tr_share_19", "soc_sp_pc_19_log"),
                     data_19, zero_infl=TRUE)

full_model_cov_19 = c('inst_qual_17', 'elites', 'pr_quan_avg', 'budg_bal_19', 'cbf_budg_tr_share_19', 'soc_sp_pc_19_log',
                      'total_eff', 'hdi_16', 'tci_19')

# Model 2
run_model('pb_count_19', full_model_coef,  full_model_cov_19,
                     data_19, zero_infl=TRUE)

# Model 3
run_model('pb_count_19', full_model_coef,  full_model_cov_19, inter_cov_1='elites',
...
##### Table 3.2 #####
# Model 1
run_model('pb_count_20', c("b_ins", "b_elt", "b_pro", "b_bal", "b_trf", "b_soc"), 
                     c('inst_qual_17', 'elites', 'pr_quan_avg', "budg_bal_20", "cbf_budg_tr_share_20", "soc_sp_pc_20_log"),
                     data_20, zero_infl=TRUE)

full_model_cov_20 = c('inst_qual_17', 'elites', 'pr_quan_avg', 'budg_bal_20', 'cbf_budg_tr_share_20', 'soc_sp_pc_20_log',
                      'total_eff', 'hdi_16', 'tci_20')

# Model 2
run_model('pb_count_20', full_model_coef,  full_model_cov_20,
                     data_20, zero_infl=TRUE)

# Model 3
run_model('pb_count_20', full_model_coef,  full_model_cov_20, inter_cov_1='elites',
...
##### Table 3.3 #####
# Model 1
run_model('pb_count_21', c("b_ins", "b_elt", "b_pro", "b_bal", "b_trf", "b_soc"), 
                     c('inst_qual_17', 'elites', 'pr_quan_avg', "budg_bal_21", "cbf_budg_tr_share_21", "soc_sp_pc_21_log"),
                     data_21, zero_infl=TRUE)

full_model_cov_21 = c('inst_qual_17', 'elites', 'pr_quan_avg', 'budg_bal_21', 'cbf_budg_tr_share_21', 'soc_sp_pc_21_log',
                      'total_eff', 'hdi_16', 'tci_21')

# Model 2
run_model('pb_count_21', full_model_coef,  full_model_cov_21,
                     data_21, zero_infl=TRUE)

# Model 3
run_model('pb_count_21', full_model_coef,  full_model_cov_21, inter_cov_1='elites',
